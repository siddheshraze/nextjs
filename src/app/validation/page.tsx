...
import FileList from '@/components/filehandling/filelist';
import SelectPlot, { SelectPlotProps } from '@/components/filehandling/selectplot';
...
export default function Validation({ plot, setPlot }: ValidateProps) {
